...
import com.hyperion.regrabber.common.BootActivity
import com.hyperion.regrabber.common.HyperionScreenService
...
class HyperionGrabberTileService : TileService() {
    ...
    private val mMessageReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            val wledEnabled = prefs.getBoolean(com.hyperion.regrabber.common.R.string.pref_key_wled_enabled)
    ...
    private fun startSetupIfNeeded(): Boolean {
        ...
        val wledEnabled = preferences.getBoolean(com.hyperion.regrabber.common.R.string.pref_key_wled_enabled)
        val hostMissing = TextUtils.isEmpty(preferences.getString(com.hyperion.regrabber.common.R.string.pref_key_host, null))
        val portMissing = preferences.getInt(com.hyperion.regrabber.common.R.string.pref_key_port, -1) == -1
        val wledIpMissing = TextUtils.isEmpty(preferences.getString(com.hyperion.regrabber.common.R.string.pref_key_wled_ip, null))

...
public class ScanResultActivity extends LeanbackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String partyPopper = "\uD83C\uDF89";
        descriptionText.setText(getResources().getString(com.hyperion.regrabber.common.R.string.scan_result_description, partyPopper));
        ...
        if (extras != null){
            ...
            hostNameText.setText(com.hyperion.regrabber.common.R.string.error_no_host_name_extra);
        }
    ...
    private void saveResult() {
        ...
        prefs.putString(com.hyperion.regrabber.common.R.string.pref_key_host, hostName);
        prefs.putInt(com.hyperion.regrabber.common.R.string.pref_key_port, port);
    }

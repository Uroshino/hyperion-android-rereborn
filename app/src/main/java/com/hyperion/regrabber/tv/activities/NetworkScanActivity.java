package com.hyperion.regrabber.tv.activities;
...
import com.hyperion.regrabber.common.network.NetworkScanner;
import com.hyperion.regrabber.common.util.HyperionScannerTask;
...
public class NetworkScanActivity extends LeanbackActivity implements HyperionScannerTask.Listener {
    ...
    public void onScannerProgress(float progress) {
        if (!isScanning){
            isScanning = true;
            startScanButton.setText(com.hyperion.regrabber.common.R.string.scanner_scan_in_progress_button);
            descriptionText.setGravity(Gravity.CENTER);
            descriptionText.setText(getString(com.hyperion.regrabber.common.R.string.scanner_scan_in_progress_text, "\uD83D\uDD75️")); // todo: 🕵️
        }
    ...
    public void onScannerCompleted(@Nullable String foundIpAddress) {
        ...
        if (foundIpAddress == null){
            startScanButton.setText(com.hyperion.regrabber.common.R.string.scanner_retry_button);
            manualSetupButton.requestFocus();
            descriptionText.setText(getString(com.hyperion.regrabber.common.R.string.scanner_no_results, "\uD83D\uDE29")); // 😩
        } else {

...
public class MainActivity extends LeanbackActivity implements ImageView.OnClickListener,
    ...
    private boolean initIfConfigured() {
        ...
        String host = preferences.getString(com.hyperion.regrabber.common.R.string.pref_key_host, null);
        int port = preferences.getInt(com.hyperion.regrabber.common.R.string.pref_key_port, -1);
